...
Partial Class log
  ...
  Private ReturnUrl As String
	...
	Protected Sub log_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
      ...
      If ReturnUrl = "" Then
        If Request IsNot Nothing AndAlso Request.UrlReferrer IsNot Nothing AndAlso Request.Url.Host = Request.UrlReferrer.Host Then
	...
	Function HrefLog(ByVal Action As LogActionType) As String
		If Action <> LogActionType.LogOn Then
			Return Href(Setting.Name, False, "log.aspx", "a", Action)
		Else
	...
	Sub LayoutNew()
		'First startup
    If OEM.VideoAtFirstStartup IsNot Nothing Then
        ...
        Case LogActionType.NewUser, LogActionType.EditUser
          ...
          If Action = LogActionType.NewUser Then
            ...
            If IsFirstRunning(Setting) = TypeOfFirstRunning.Application Then
              ...
              End If
              If AfterCreationOfSupervisorAccountGoToPage IsNot Nothing Then
                ReturnUrl = AfterCreationOfSupervisorAccountGoToPage
              Else
