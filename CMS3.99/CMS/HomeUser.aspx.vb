...
Partial Class HomeUser
	...
	Sub SetPanel()
		...
		Else
			'Is current user
			'Add Button Log Off
			Operations.Controls.Add(Components.Button(Setting, Phrase(Setting.Language, 22), Href(Setting.Name, False, "log.aspx", "a", LogActionType.LogOff), , IconType.Globe))
		End If

		If StrComp(CurrentUser.Username, UserProfile.Username, CompareMethod.Text) = 0 Then
			'Add button Modify Profile
			Operations.Controls.Add(Components.Button(Setting, Phrase(Setting.Language, 320), Href(Setting.Name, False, "log.aspx", "a", LogActionType.EditUser), , IconType.ControlPanel))
		End If
		...
		Dim HrefMessageBoard As String = Href(Setting.Name, False, "forum.aspx", "reference", UserProfile.Username, "f", ReservedForums.PrivateMessage)
	...
	Sub PopulateInfoPanel()
        ...
        AddInfo(Phrase(Setting.Language, 19), Gender, , , "gender")
			...
			If UserProfile.Phone <> "" Then
				AddInfo(Phrase(Setting.Language, 15), UserProfile.Phone, , "callto://" & UserProfile.Phone, "telephone")
			End If
    ...
    If Not PhotoAlbum Is Nothing Then
      ...
      Dim Button As Control = Components.Button(Setting, Phrase(Setting.Language, 3224), Href(Setting.Name, False, "thumbnails.aspx", "album", PhotoAlbum.Name), , IconType.FolderPics1)
