      ...
      If Plugin Is Nothing Then Plugin = New PluginManager.Plugin(AddressOf Description, , , , , GetType(FacebookLikeFlyingButtonConfiguration))
		...
		Private Shared Sub Plugin_MasterPagePreRender(ByVal MasterPage As Components.MasterPage) Handles Plugin.MasterPagePreRender
			...
			If HttpContext.Current.Request.Browser.EcmaScriptVersion.Major >= 1 Then 'Verify is browser support javascript
              ...
              Dim Code As String = ReplaceBin(HtmlCodeInUsersToolsBar, CanonicalUrlNameVariable, HttpUtility.HtmlEncode(HttpContext.Current.Request.Url.AbsoluteUri)) & ReplaceBin(FlyingScript, "speed", Configuration.Speed)
