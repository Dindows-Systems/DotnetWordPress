...
Namespace WebApplication
  ...
  Public Module OEM
    ...
    Public Const DefaultSkin As String = Nothing 'Is case sensitive and the first char must be uppercase! Ex.: "Default", "Best Skyn".
  ...
  End Module
	...
	Public Module Config
      ...
      Class AmbientConfiguration
        ...
        Enum HtmlEditorNames
          Html5Editor1Kb 'By Andrea Bruno 1k HTML5 editor!
          TinyMCE
        End Enum
      End Class
      ...
      Class ReportErrorsByEmailConfiguration
        ...
        Public ExcludeError404 As Boolean = True
      End Class
      ...
      End Class
        ...
        Public EnableProxyUsersToInteract As Boolean
			...
			Class SearchEngineOptimizationConfiguration
				...
				Public AtGooglebootExcludeIndexedPagesInSitemap As Boolean = True
    ...
    Public TimeArchiveNews As TimeSpan = New TimeSpan(60, 0, 0, 0)
    ...
    Public Sub CheckWritePermission()
      ...
      If Checked = False OrElse InError = True Then
        ...
        If InError Then
          ...
          If False Then ' Switch the error message type
            Err.Raise(70, , ErrorMessage)
          Else
            ErrorMessage = "<html><body><h1>" & ErrorMessage & "<br><a href='http://www.cmsaspnet.com/forum.aspx?f=202&c=1'>Online Technical Support</a></h1></body></html>"
    ...
    Public Sub Run()
      ...
      ''Consigure host for the firs StartUp
      'If AllSubSiteNames() Is Nothing Then
      '	'Is the first StartUp!
      '	Dim SubSite As New SubSite
      '	SubSite.Name = "default"
      '	SubSite.Save()
      '	Dim AdminName As String = "admin"
      '	Dim Admin As User = User.Load(AdminName)
      '	If Admin Is Nothing Then
      '		Admin = New User
      '		Admin.Username = AdminName
      '		Admin.GeneralRole = User.RoleType.Supervisor
    ...
    Public Class SubSite
      ...
      Shared Function DefaultSiteConfiguration() As String
        If OEM.DefaultSiteConfiguration IsNot Nothing Then
      ...
      Property DateFormat As String
        ...
        End Set
      End Property
      Private m_TimeFormat As String = "H\:mm\:ss"
      ...
      Public Property IdSkin As String
        Get
          ...
          Else
            ...
            If OEM.DefaultSkin IsNot Nothing Then
      ...
      If Not Src Is Nothing Then
        ...
        Select Case FileManager.Extension(File)
          Case "gif", "jpg", "jpeg", "png"
            ...
            Else
              Image.Attributes("alt") = HttpContext.Current.Request.Url.Host
            End If
