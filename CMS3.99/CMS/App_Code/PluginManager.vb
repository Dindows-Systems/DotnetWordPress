...
Namespace WebApplication
    ...
    End Function
      ...
      Event BeforeEditPluginConfiguration(ByVal Configuration As Object)
      Event BeforeEditPluginSharedConfiguration(ByVal Configuration As Object)
          ...
          RaiseEvent BeforeEditPluginConfiguration(EditObjectParameters.ObjectToEdit)
          ...
          RaiseEvent BeforeEditPluginSharedConfiguration(EditObjectParameters.ObjectToEdit)
          EditObjectParameters.SaveObjectMethod = Sub()
                                                         RaiseEventBeforeSavePluginConfiguration(EditObjectParameters.ObjectToEdit, ConfigurationType)
