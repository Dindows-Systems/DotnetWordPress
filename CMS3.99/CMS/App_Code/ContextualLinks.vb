Namespace WebApplication
  Public Class ContextualLink
    ...
    Const Algorithm As Integer = 1 'Switch 0=Classic, 1=Recursive (0 is fast for short vocabolary, 1 is fast for big vocabolary but slow for short)
        ...
        If Links IsNot Nothing OrElse LinkFinderStructure IsNot Nothing Then
          ...
          If AddWWW = ContextualLink.AddWWW.Auto Then
            ...
            Catch ex As Exception
              Log("SpecificError", 1000, "ExecuteAddLinksToText", ex.Source, ex.Message, ex.StackTrace)
            End Try
      ...
      If Not Links Is Nothing Then
        For Each Language As LanguageManager.Language In LanguageManager.LanguagesUsed
          ...
          Select Case Algorithm
            ...
            Case Else
              Dim QuickLinkFinder As New LinkFinderStructure(LinksSorted)
              LinkFinderStructuresByLanguage.Add(Language, QuickLinkFinder)
          End Select
