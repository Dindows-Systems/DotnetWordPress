        ...
        Select Case Operation
          ...
          Case Operations.MakeJavascriptPhotosList
            ...
            For Each TextValue As TextValue In ListPhotos.item
              Texts &= IfStr(Texts IsNot Nothing, ",", "") & """" & AbjustForJavascriptString(TextValue.text) & """"
              Values &= IfStr(Values IsNot Nothing, ",", "") & """" & AbjustForJavascriptString(TextValue.value) & """"
            Next
    ...
    Select Case Operation
      ...
      Case PhotoManager.Operations.Delete
        ...
        If IsNothing(ParentAlbum) Then
          Response.Redirect("?ss=" & Request.QueryString("ss"))
        Else
