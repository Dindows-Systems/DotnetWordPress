  ...
  Shared Plugin As New PluginManager.Plugin(, , , , Plugin.Characteristics.CorePlugin)
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		If EditObjectParameters IsNot Nothing Then
			...
			Dim TablePropertyPhraseCorrispondence As Collections.Generic.Dictionary(Of String, Integer) = EditObjectParameters.TablePropertyPhraseCorrispondence
			...
			If IsPostBack Then
				...
				PlaceHolder1.Controls.Add(ObjectToControl(Setting, Obj, TablePropertyPhraseCorrispondence, NamePhraseBooks, Request, RetriveSetError, EditObjectParameters.FilterExcludeProperties, EditObjectParameters.FilterIncludeProperties, EditObjectParameters.FilterArray))
          ...
          MasterPage.AddMessage(Setting, 27)
			...
			Else
				...
				PlaceHolder1.Controls.Add(ObjectToControl(Setting, Obj, TablePropertyPhraseCorrispondence, NamePhraseBooks, , , EditObjectParameters.FilterExcludeProperties, EditObjectParameters.FilterIncludeProperties, EditObjectParameters.FilterArray))
			End If
		Else
