				...
				Else
				 ...
				 "</object>"
					ElseIf UseVideoPlayer = VideoPlayer.FlashPlayer Then
						...
						'W3C valid html code
            Literal.Text = "<object type=""application/x-shockwave-flash""  " & VideoSize(Setting, Width, Height) & " data=""" & FlashResources & "/FVP10.swf?video=" & HttpUtility.HtmlEncode(VideoId) & "&amp;action=stop&amp;color=ADBBC9&amp;buffer=3&amp;fsbtn=yes&amp;textcolor=000000""><param name=""movie"" value=""" & FlashResources & "/FVP10.swf?video=" & HttpUtility.HtmlEncode(VideoId) & "&amp;action=stop&amp;color=ADBBC9&amp;buffer=3&amp;fsbtn=yes&amp;textcolor=000000"" /><param name=""allowFullScreen"" value=""true"" /></object>"
					End If
				End If
			Else
				Select Case Len(VideoId)
					Case 8
						...
						'W3C valid html code
            Literal.Text = "<object type=""application/x-shockwave-flash"" " & VideoSize(Setting, Width, Height) & " data=""http://vimeo.com/moogaloop.swf?clip_id=" & VideoId & "&amp;server=vimeo.com&amp;color=00adef&amp;fullscreen=1""><param name=""movie"" value=""http://vimeo.com/moogaloop.swf?clip_id=" & VideoId & "&amp;server=vimeo.com&amp;color=00adef&amp;fullscreen=1"" /><param name=""allowFullScreen"" value=""true"" /></object>"
					Case 6
						'Dailymotion.com
						Height += 52
