	...
	<asp:Panel ID="Ecard" runat="server">
		<table runat="server" id="SendECard">
			...
			<tr>
				...
				<td>
					<asp:TextBox ID="SubjectEcard" onkeypress="document.getElementById('AR').value++" required="required" runat="server" MaxLength="50" Width="22em"></asp:TextBox>
			...
			<tr>
				<td style="white-space: nowrap; text-align: right" colspan="2">
					<input id="AR" clientIDMode="Static" runat="server" type="hidden" value="0" />
